...
public class main {
	...
	public static void main(String[] args) {
		...
		listaPodemon.add(new Sireno(30, 10, 3, "Scar", new Habilidad("Atropellar con la moto", 10, 5)));
		listaPodemon.add(new Sireno(10, 10, 10, "Goliat", new Habilidad("Mirar mal (intimidar)", 15, 5)));
